...
void ofxKCoreVision::setupControls()
{
	...
	tPanel->addSlider(appPtr->TemplatePanel_minArea, "Near mm", 140, 13, 0, 5000, nearThreshold, kofxGui_Display_Int, 1);
	tPanel->addSlider(appPtr->TemplatePanel_maxArea, "Far mm", 140, 13, 0, 5000, farThreshold, kofxGui_Display_Int, 1);
