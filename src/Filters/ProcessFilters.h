...
public:
    ...
    void drawOrg(){
        ...
        original.draw(0, 0, ofGetWidth(), ofGetHeight());  //SET DIMENSIONES
    }

    void draw(){
//        grayImg.draw(30, 15, 320, 240);
        original.draw(30, 15, 320, 240);  //SET DIMENSIONES
        grayDiff.draw(375, 15, 320, 240); //SET DIMENSIONES
